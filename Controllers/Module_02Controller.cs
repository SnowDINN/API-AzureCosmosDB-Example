...
namespace NorthEducationAPI.Controllers
{
    ...
    [ApiController]
    public class Module_02Controller : ControllerBase
    {
        private readonly IModule_02CosmosDbService _cosmosDbService;

        public Module_02Controller(IModule_02CosmosDbService cosmosDbService)
        {
