...
namespace NorthEducationAPI.Controllers
{
    ...
    [ApiController]
    public class Module_05Controller : ControllerBase
    {
        private readonly IModule_05CosmosDbService _cosmosDbService;

        public Module_05Controller(IModule_05CosmosDbService cosmosDbService)
        {
