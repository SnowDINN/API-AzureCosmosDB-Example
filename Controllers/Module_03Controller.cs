...
namespace NorthEducationAPI.Controllers
{
    ...
    [ApiController]
    public class Module_03Controller : ControllerBase
    {
        private readonly IModule_03CosmosDbService _cosmosDbService;

        public Module_03Controller(IModule_03CosmosDbService cosmosDbService)
        {
