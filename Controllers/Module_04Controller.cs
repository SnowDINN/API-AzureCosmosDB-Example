...
namespace NorthEducationAPI.Controllers
{
    ...
    [ApiController]
    public class Module_04Controller : ControllerBase
    {
        private readonly IModule_04CosmosDbService _cosmosDbService;

        public Module_04Controller(IModule_04CosmosDbService cosmosDbService)
        {
